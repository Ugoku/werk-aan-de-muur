		...
		$output = sprintf(
			'<div class="wadm-single-artwork">
				...
				<p class="wadm-artwork-price">
					<a href="%1$s" class="wadm-artwork-link" title="%2$s" target="_blank">
			...
			__('Te koop op meerdere materialen in een zelfgekozen formaat'),
			sprintf(__('Canvas <strong>%sx%s</strong> voor <strong>%s</strong>', Wadm::TEXT_DOMAIN), $artwork->pricing[1], $artwork->pricing[2], $artwork->pricing[0])
		);
